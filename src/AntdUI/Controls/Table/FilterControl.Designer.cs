...
namespace AntdUI
{
    partial class FilterControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnPanel = new Majorsilence.Forms.TableLayoutPanel();
            btn_ok = new Button();
            ...
            dv.Dock = Majorsilence.Forms.DockStyle.Fill;
            dv.Gaps = new System.Drawing.Size(4, 8);
            dv.Location = new System.Drawing.Point(0, 66);
            dv.Margin = new Majorsilence.Forms.Padding(0);
            dv.Name = "dv";
            ...
            inputSearch.Dock = Majorsilence.Forms.DockStyle.Top;
            inputSearch.Location = new System.Drawing.Point(0, 34);
            inputSearch.Margin = new Majorsilence.Forms.Padding(0);
            ...
            selectCondition.Dock = Majorsilence.Forms.DockStyle.Fill;
            ...
            selectCondition.Margin = new Majorsilence.Forms.Padding(0);
            ...
            tablePanel.ColumnStyles.Add(new Majorsilence.Forms.ColumnStyle(Majorsilence.Forms.SizeType.Absolute, 34F));
            ...
            tablePanel.RowStyles.Add(new Majorsilence.Forms.RowStyle(Majorsilence.Forms.SizeType.Percent, 100F));
            ...
            btnPanel.ColumnStyles.Add(new Majorsilence.Forms.ColumnStyle(Majorsilence.Forms.SizeType.Percent, 50F));
            btnPanel.ColumnStyles.Add(new Majorsilence.Forms.ColumnStyle(Majorsilence.Forms.SizeType.Percent, 50F));
            btnPanel.Controls.Add(btn_ok, 1, 0);
            btnPanel.Controls.Add(btn_clean, 0, 0);
            btnPanel.Dock = Majorsilence.Forms.DockStyle.Bottom;
            btnPanel.Location = new System.Drawing.Point(0, 266);
            btnPanel.Name = "btnPanel";
            btnPanel.RowCount = 1;
            btnPanel.RowStyles.Add(new Majorsilence.Forms.RowStyle(Majorsilence.Forms.SizeType.Percent, 50F));
            btnPanel.Size = new System.Drawing.Size(200, 34);
            btnPanel.TabIndex = 3;
            // 
            // btn_ok
            // 
            btn_ok.Dock = Majorsilence.Forms.DockStyle.Fill;
            btn_ok.LocalizationText = "OK";
            btn_ok.Location = new System.Drawing.Point(100, 0);
            btn_ok.Margin = new Majorsilence.Forms.Padding(0);
            btn_ok.Name = "btn_ok";
            ...
            // btn_clean
            // 
            btn_clean.Dock = Majorsilence.Forms.DockStyle.Fill;
            ...
            btn_clean.Margin = new Majorsilence.Forms.Padding(0);
        ...
        private Majorsilence.Forms.TableLayoutPanel btnPanel;
